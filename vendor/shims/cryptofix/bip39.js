...
/* istanbul ignore next */
if (require$$0 && (!require$$0.pbkdf2Sync || require$$0.pbkdf2Sync.toString().indexOf('keylen, digest') === -1)) {
  exports.pbkdf2 = async;
  exports.pbkdf2Sync = sync;
} else {
  exports.pbkdf2Sync = require$$0.pbkdf2Sync;
  exports.pbkdf2 = require$$0.pbkdf2;
}
});
...
var chinese_simplified$1 = Object.freeze({
...
var chinese_traditional$1 = Object.freeze({
...
var spanish$1 = Object.freeze({
	default: spanish
});

var CHINESE_SIMPLIFIED_WORDLIST = ( chinese_simplified$1 && chinese_simplified ) || chinese_simplified$1;

var CHINESE_TRADITIONAL_WORDLIST = ( chinese_traditional$1 && chinese_traditional ) || chinese_traditional$1;

var ENGLISH_WORDLIST = ( english$1 && english ) || english$1;

var FRENCH_WORDLIST = ( french$1 && french ) || french$1;

var ITALIAN_WORDLIST = ( italian$1 && italian ) || italian$1;

var JAPANESE_WORDLIST = ( japanese$1 && japanese ) || japanese$1;

var KOREAN_WORDLIST = ( korean$1 && korean ) || korean$1;

var SPANISH_WORDLIST = ( spanish$1 && spanish ) || spanish$1;

var Buffer$3 = safeBuffer.Buffer;

var pbkdf2$3 = pbkdf2$1.pbkdf2Sync;
...
function mnemonicToSeed (mnemonic, password) {
  ...
  return pbkdf2$3(mnemonicBuffer, saltBuffer, 2048, 64, 'sha512')
}
